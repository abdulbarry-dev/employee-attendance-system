<div>
    ...
    <div class="flex items-center justify-between gap-4 mb-24">
        <!-- Present -->
        <div class="relative w-full max-w-[14rem] overflow-hidden rounded-xl bg-white p-6 shadow-[0_2px_8px_rgba(0,0,0,0.04)] ring-1 ring-zinc-900/5 dark:bg-zinc-800 dark:ring-zinc-100/10 transition-all hover:scale-[1.01] aspect-square flex flex-col justify-center">
        ...
        <!-- Absent -->
        <div class="relative w-full max-w-[14rem] overflow-hidden rounded-xl bg-white p-6 shadow-[0_2px_8px_rgba(0,0,0,0.04)] ring-1 ring-zinc-900/5 dark:bg-zinc-800 dark:ring-zinc-100/10 transition-all hover:scale-[1.01] aspect-square flex flex-col justify-center">
            <dt class="truncate text-sm font-medium text-zinc-500 dark:text-zinc-400">{{ __('Absent / Late') }}</dt>
            <dd class="mt-4 flex items-baseline gap-2">
