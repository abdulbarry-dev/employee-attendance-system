                ...
                @if($monthlySalary > 0)
                    <div class="grid gap-4 md:grid-cols-3">
                        <div class="flex items-center justify-between rounded-lg bg-zinc-50 p-4 dark:bg-zinc-800">
                            <div class="flex-1">
                                <div class="flex items-center gap-2">
                                    <p class="text-xs font-medium uppercase tracking-wider text-zinc-500 dark:text-zinc-400">{{ __('Prorated Salary') }}</p>
                                    <div class="group relative">
                                        ...
                                        <div class="invisible absolute bottom-full left-1/2 mb-2 w-48 -translate-x-1/2 transform rounded-lg bg-zinc-900 p-3 text-xs text-white shadow-lg group-hover:visible dark:bg-zinc-800">
                                            <p class="font-semibold mb-1">{{ __('Prorated Salary Calculation') }}</p>
                                            <p>{{ __('You worked') }} <span class="font-semibold">{{ $currentAttendanceDays }}</span> {{ __('out of') }} <span class="font-semibold">{{ $currentWorkingDays }}</span> {{ __('working days this month') }}</p>
                        ...
                        <div class="flex items-center justify-between rounded-lg bg-red-50 p-4 dark:bg-red-900/20">
                            <div>
                                <p class="text-xs font-medium uppercase tracking-wider text-red-600 dark:text-red-400">{{ __('Penalties') }}</p>
                    ...
                    <table class="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
                        <thead class="bg-zinc-50 dark:bg-zinc-800">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-right text-xs font-medium uppercase tracking-wider text-zinc-700 dark:text-zinc-300">{{ __('Gross') }}</th>
                        ...
                        <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                            @foreach($months as $month)
                                <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-right font-mono text-sm text-zinc-700 dark:text-zinc-200">{{ number_format($month['gross'], 2) }}</td>
