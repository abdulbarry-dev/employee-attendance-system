<div class="max-w-md mx-auto py-12 px-4 sm:px-0">
    <!-- Flash Messages -->
    @if(session('error'))
        <div class="mb-6 rounded-xl border-2 border-red-200 bg-red-50 p-4 dark:border-red-900/30 dark:bg-red-900/10">
    ...
    @if(session('success'))
        <div class="mb-6 rounded-xl border-2 border-emerald-200 bg-emerald-50 p-4 dark:border-emerald-900/30 dark:bg-emerald-900/10">
            <div class="flex items-start gap-3">
